...
(function() {
  ...
  function createInfoHotspotElement(hotspot) {
    /*console.log("Here's the hotspot");
    console.log(hotspot);
    if(hotspot.fullscreen){
      console.log("this info hotspot should be fullscreen");
    } */
    if(!hotspot.fullscreen) {
      // Create wrapper element to hold icon and tooltip.
      var wrapper = document.createElement('div');
      ...
      var wrapper = document.createElement('div');
      wrapper.classList.add('hotspot');
      wrapper.classList.add('info-hotspot-f');
      //wrapper.classList.add('info-hotspot-modal');
